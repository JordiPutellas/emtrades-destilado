...
- Visualmente aparece en XAUUSD t30 (30 ticks)/5s/1m/5m, GBPUSD 5m/D1 y EURUSD D1, a ambos lados del mercado; la fuente la presenta como fractal, no ligada a un instrumento/TF. **Fractalidad en cuatro escalas** (t30 ticks → 5min → 5min → D1 de 5 meses): la demostración fractal mejor documentada del corpus para un setup concreto. [IMG: CLP/EEBe34cXoAEhKWw.png] [IMG: CLP/EFyeKT-XkAAP053.png] [IMG: CLP/EEBnCEJWkAMJEdf.png] [IMG: CLP/EUR CPL.jpg] [IMG: CLP/EEBYb6-WsAAp2N-.png] [IMG: CLP/EEBaBCGXkAIIhpc.png] [IMG: CLP/EEBgtXpXUAAoEmR.png] [IMG: CLP/EEBhSR1XsAAh-uH.png]
