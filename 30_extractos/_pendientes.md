...
**Cierre del corpus visual (237/237) — mapa para no repetir búsquedas:** Discord y CLP quedan agotados. **Washed IV** queda resuelto operativamente por CLP; solo faltan los parámetros de ejecución que EM dice tener pero no revela. Para **SWE y criterios shelf-specific de washed**, revisar M2020 S1-S11 y después Price Swing. Para **template 4-apex, gestión de apex y second level information**, priorizar M2020 S1-S11; Price Swing solo como precursor, y sigue siendo posible que el archivo formal estuviera en el drive perdido. Para **CPS como setup** y el **poke past the low del OP**, priorizar M2020 S1-S11; Price Swing conserva el marco antiguo. Para **YO/WO/MO** y **responsive vs market-state-dependent**, M2020 S1-S11 es el candidato principal y Price Swing el secundario. Para **fractal pushing** y **HOTW**, empezar por Price Swing 1-10 y después M2020 S1-S11.
